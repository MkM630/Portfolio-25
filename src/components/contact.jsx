      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <footer className=" mt-12  text-center">
          ...
          <div className="flex justify-center mt-4 space-x-6 text-xl">
            <a href="https://www.facebook.com/mainak.maitra.376/" className="text-blue-600 hover:text-blue-800">
              <i className="bx bxl-facebook"></i>
            </a>
            <a href="https://www.instagram.com/mainak.maitra.376/" className="text-blue-600 hover:text-blue-800">
